...
def main():
    ...
    ap.add_argument("--ckpt", default="ckpt/time.v1.0.eikonal.pt", help="checkpoint path, e.g. run_fm3d/run_demo/data/pinn_tt.ckpt.pt")
    ...
    Xs[:, 2] = np.random.uniform(0, 30, [10000])
