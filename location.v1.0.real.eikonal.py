...
ckpt_path = 'ckpt/time.v1.0.eikonal.pt'
...
if __name__ == "__main__":
    ...
    events, ctlg, proj_fwd, proj_inv = read_real_file("data/real.txt", "data/station.txt")
    # 拟合 GMM 作为先验
    ...
    ofile = open(f"run_fm3d/data/ours/reloc.real.{use_student_t}.eikonal.v1.0.txt", "w")
