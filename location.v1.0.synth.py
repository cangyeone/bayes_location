...
if __name__ == "__main__":
    ...
    events, ctlg, proj_fwd, proj_inv = read_real_file("run_fm3d/data/loc.synth_arrivals_skfmm_noise.new.txt", "run_fm3d/data/loc.synth_stations.new.txt")
    # 拟合 GMM 作为先验
    ...
    ofile = open(f"run_fm3d/data/ours/reloc.synth.{use_student_t}.v1.0.txt", "w")
