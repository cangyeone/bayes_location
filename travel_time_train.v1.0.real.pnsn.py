...
def main():
    ...
    ap.add_argument("--rel_t_max", type=float, default=200.0)
    ...
    ap.add_argument("--save_ckpt", default="ckpt/time.real.pnsn.v1.0.pt", help="checkpoint path to save (e.g., pinn_tt.ckpt.pt)")
    ap.add_argument("--save_every", type=int, default=1, help="save every N epochs")
    ap.add_argument("--resume", default="ckpt/time.real.pnsn.v1.0.pt", help="checkpoint path to resume/load")
