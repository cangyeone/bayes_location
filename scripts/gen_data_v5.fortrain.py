...
class Config:
    ...
    # event sampling
    xy_step_events: int = 2
    event_depths_km: Tuple[float, ...] = (0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)
    ...
    # output
    out_arrivals: str = "run_fm3d/data/train.synth_arrivals_skfmm_noise.new.txt"
    out_stations: str = "run_fm3d/data/train.synth_stations.new.txt"
    out_events_vel: str = "run_fm3d/data/train.synth_events_vel.new.txt"
    out_stations_vel: str = "run_fm3d/data/train.synth_stations_vel.new.txt"
