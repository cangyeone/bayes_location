...
class Config:
    ...
    # output
    out_arrivals: str = "run_fm3d/data/test.synth_arrivals_skfmm_noise.new.txt"
    out_stations: str = "run_fm3d/data/test.synth_stations.new.txt"
    out_events_vel: str = "run_fm3d/data/test.synth_events_vel.new.txt"
    out_stations_vel: str = "run_fm3d/data/test.synth_stations_vel.new.txt"
